function [FitnessMatrix,DecisionMatrix,HuntCount,ScavCount,KlepCount] =...
    SDPfunction(Mp,Mr,Mc,tvec,AllometricStruct,pp,rr,cc,KlepEncNumVec,KlepEncProbVec,HuntEncNumVec,HuntEncProbVec,ScavEncNumVec,ScavEncProbVec)

%function that does SDP computation
...
F = FitnessFunction(x/xmax); %terminal fitness function %fitness defined relative to maximum possible energetic state
...
[HuntCount,ScavCount,KlepCount] = deccount_func(DecisionMatrix);
