...
%Feb 2023: This is a version of the script used to run the SDP to get results to use as a baseline for various sensitivity analyses. So, this utilises an
%exponential fitness function, a 12 hr:12 hr split of activity and rest, linkining probablity per Rohr with parameters as cited in our paper, and
...
for trial = 1:5 
    ...
    %loops to make name
    fitsavename = sprintf('FitDecExpfitness_SensBaselineFeb2023_%i.mat',trial);
    countssavename = sprintf('StrategyCountsExpfitness_SensBaselineFeb2023_%i.mat',trial);
    probsavename = sprintf('SdpEncProbExpfitness_SensBaselineFeb2023_%i.mat',trial);
