...
%Feb 2023: This is a version of the script used to run the SDP to get results for sensitivity analyses where in the Rohr link prob eqn, the predator-prey mass
% ratio is inverted. ie. it is Mr/Mp instead of Mp/Mr. Everything else remains the same.  So, this utilises an
...
AllometricStruct = GenerateAllomtericQuantities_LinkProbInvBodyMassRatio(Mp,Mr,Mc);
...
for trial = 1:5 
    ...
    %loops to make name
    fitsavename = sprintf('FitDecExpfitness_SensLinkProbInvBodyMassRatioJun2023_%i.mat',trial);
    countssavename = sprintf('StrategyCountsExpfitness_SensLinkProbInvBodyMassRatioJun2023_%i.mat',trial);
    probsavename = sprintf('SdpEncProbExpfitness_SensLinkProbInvBodyMassRatioJun2023_%i.mat',trial);
