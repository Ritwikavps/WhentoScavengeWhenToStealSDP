function [FitnessMatrix,DecisionMatrix,HuntCount,ScavCount,KlepCount] =...
    SDPfunction(Mp,Mr,Mc,tvec,AllometricStruct,pp,rr,cc,KlepEncNumVec,KlepEncProbVec,HuntEncNumVec,HuntEncProbVec,ScavEncNumVec,ScavEncProbVec,FitnessFuncType)
